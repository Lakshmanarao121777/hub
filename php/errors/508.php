  ...
  <div class="container" style="overflow-y: hidden;">
  	<div class="">
      	<div class="comesoonbox" style="width:80%;padding:5% 2%;">
       		...
       		<div class="comesoontext">  Oops.. 508 Error </div>
					<div class="comesoonsubtext">Resource Limit is exceeded.Please try again after some time.<br>Please <a href='#' onClick='javascript:history.go(-1);'>Go Back to previous Page </a></div>
				</div>
    </div>
  </div>
