  ...
  <div class="container" style="overflow-y: hidden;">
  	<div class="">
      	<div class="comesoonbox" style="width:80%;padding:5% 2%;">
       		...
       		<div class="comesoontext">  Oops.. 404 Error </div>
					<div class="comesoonsubtext">The Page you are looking is not found on this server.<br>Please <a href='#' onClick='javascript:history.go(-1);'>Go Back to previous Page </a></div>
				</div>
    </div>
  </div>
