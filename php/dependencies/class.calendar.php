...
class PHPCalendar {
	...
	function getCalendarNavigation() {
		...
		$navigationHTML = '<div class="prev" data-prev-month="' . $prevMonthYearArray[0] . '" data-prev-year = "' . $prevMonthYearArray[1]. '"><span class="fa fa-arrow-left"></span></div>'; 
		...
		$navigationHTML .= '<div class="next" data-next-month="' . $nextMonthYearArray[0] . '" data-next-year = "' . $nextMonthYearArray[1]. '"><span class="fa fa-arrow-right"></span></div>';
