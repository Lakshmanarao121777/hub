...
<body>
      ...
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-key"></span> Update Password</em></a></li>
		...
		<form onsubmit="changepassword();return false;" name= "activity_student_changepassword" >
			<div class="inp">
				...
				<div class="inp_value">
				<button type="reset" id="reset" class="btn btn-warning"><span class="fa fa-refresh"> </span> Reset Password</button>
				</div>
			</div>
		</form>
	</div>
	...
	function showimg(){
		...
		msg=msg.toUpperCase();
		if( msg.length==7){
			var jj='<div class="inp_name">Student Picture Confirmation :</div>	<div class="inp_value" id="img_confirm"><img src="http://10.50.50.56/Registrations/upload/'+msg+'/'+msg+'.jpg" style="width:100px;height:120px;"></div> '
