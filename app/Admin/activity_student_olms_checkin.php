...
<body>
  ...
  <div class="container bg_white" style="padding:0;">
    <ul class="bread">
      ...
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-sign-in"></span> Checked In</em></a></li>
    </ul>
    ...
    <h3><center><i>Student Out-Pass System (Check In)</i></center></h3>
    <div class="inp">
    ...
    <input type="hidden" id="status" value="chekedIn"><?php
...
?>
  ...
  //<![CDATA[
    ...
    function  load_olms(began){
      var end=began+20;
      var values =["load_olms",began,end,'chekedIn'];
