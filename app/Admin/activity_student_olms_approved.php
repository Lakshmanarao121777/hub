...
<body>
  ...
  <div class="container bg_white" style="padding:0;">
    <ul class="bread">
      ...
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-check"></span> Approved</em></a></li>
    </ul>
    <div class="dash_box">
    ...
    <h3><center><i>Student Out-Pass System (Approved Leaves)</i></center></h3>
    <div class="inp">
    ...
    <input type="hidden" id="status" value="approved">
    <?php
  ...
  <script type="text/javascript" src="../../assets/js/nicEdit-latest.js"></script> <script type="text/javascript">
	//<![CDATA[
	  ...
	  function  load_olms(began){
	  	var end=began+20;
	  	var values =["load_olms",began,end,'approved'];
