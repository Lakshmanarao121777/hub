...
<body>
    ...
    <ul class="bread">
      ...
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-user-edit"></span> Edit User</em></a></li>
    </ul>
		<div class="inp">
			<div class="inp_name">Enter Student ID number</div>
			<div class="inp_value"><input type="text" require autocomplete="off" placeholder="Student ID number" /></div>
		</div>
	</div>
