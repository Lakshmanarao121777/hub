...
<body>
  ...
  <div class="container bg_white" style="padding:0;">
    <ul class="bread">
      ...
      <li><a href="activity_student_olms" title=""><em><span class="fa fa-sign-out-alt"></span> Leaves</em></a></li>
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-sign-out-alt"></span> Checked Out</em></a></li>
    </ul>

    <div class="dash_box">
        <a href="activity_student_olms_approved">
    ...
    <div class="dash_box">
        <a href="activity_student_olms_pending">
      ...
      <div class="dash_box">
        <a href="activity_student_olms_rejected">
      ...
      <div class="dash_box">
        <a href="activity_student_olms_checkout">
      ...
      <div class="dash_box">
        <a href="activity_student_olms_checkin">
      ...
      <div class="dash_box">
        <a href="activity_student_olms_stat">
      ...
      <div class="dash_box">
        <a href="activity_student_olms_all">
    ...
    <h3><center><i>Student Out-Pass System (Check Out)</i></center></h3>
    <div class="inp">
    ...
    <input type="hidden" id="status" value="chekedOut">
    <?php
...
?>
  ...
  //<![CDATA[
    ...
    function  load_olms(began){
      var end=began+20;
      var values =["load_olms",began,end,'chekedOut'];
    ...
    function olms_action(ac,actions)
    {
      ...
      alert(msg);
      if(msg==" Sucessfull"){
        window.location.href="activity_student_olms_all";
      }
    }
    $(function(){
