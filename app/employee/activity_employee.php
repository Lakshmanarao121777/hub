...
<body>
  ...
  <div class="container bg_white" style="padding:0 0 20px 0;">
    ...
    <li><a href="./" title=""><em><span class="fa fa-tachometer-alt"></span> Dashboard</em></a></li>
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-user-tie"></span> Employee Activity</em></a></li>
    </ul>
    <br>
    <?php if($user_ofc=="Admin" || $user_ofc=="SoftwareCell" || $user_designation=="admin"){?>
      <div class="dash_box">
        <a href="activity_employee_add">
      ...
      <div class="dash_box">
        <a href="activity_employee_password">
          <span class="fa fa-lock icon" ></span> <div class="link_text"> Password User <span class="fa fa-arrow-alt-circle-right sm-icon"> </span></div>
        </a>
      </div>
    <?php } 
    if($user_designation=="Director" || $user_designation=="DeanAcademic" || $user_designation=="SoftwareCell" || $user_designation=="admin" || $user_ofc=="SWO" || $user_designation=="AO"){ ?>
      <div class="dash_box">
        <a href="activity_employee_search">
