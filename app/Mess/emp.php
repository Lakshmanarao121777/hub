...
<body>
  ...
  <div class="container bg_white" style="padding:0;">
    ...
    <div class="dash_box">
      <a href="emp_servey">
        <span class="fa fa-plus-circle icon" ></span> <div class="link_text"> Create Survey <span class="fa fa-arrow-alt-circle-right sm-icon"> </span></div>
      </a>
    </div>
    <div class="dash_box">
      <a href="emp_feedback_history">
