...
<body>
  ...
  <div class="container bg_white" style="padding:0 0 20px 0;">
    <ul class="bread">
      ...
      <li class="breadcurrent"><a href="" title=""><em><span class="fa fa-university"></span> Semister Data</em></a></li>
    </ul>
    <br>
    <div class="dash_box">
      <a href="ay1819s1_regular">
        <span class="fa fa-university icon" ></span> <div class="link_text"> AY18-19 SEM-1 <span class="fa fa-arrow-alt-circle-right sm-icon"> </span></div>
      </a>
    </div>
    <div class="dash_box">
      <a href="ay1819s2_regular">
        <span class="fa fa-user icon" ></span> <div class="link_text"> AY18-19 SEM-2 <span class="fa fa-arrow-alt-circle-right sm-icon"> </span></div>
      </a>
    </div>
