...
<body>
  ...
  <div class="container bg_white">
    ...
    <?php }
    else if($_SESSION['USER_ID']=="WBP2" ||$_SESSION['USER_ID']=="WGP2"){ ?>
      <input type="hidden" id="cYear" value="PUC-2">
      <input type="hidden" id="branch" value="PUC-2">
    <?php }
    else if($_SESSION['USER_ID']=="WGPA" || $_SESSION['USER_ID']=="WBPA"){ ?>
      <div class="inp">
    ...
    <?php }
    else if($_SESSION['USER_ID']=="WBE1" || $_SESSION['USER_ID']=="WGE1"){ ?>
    ...
    <?php }
    else if($_SESSION['USER_ID']=="WBE2" || $_SESSION['USER_ID']=="WGE2"){ ?>
    ...
    <?php }
    else if($_SESSION['USER_ID']=="WBE3" || $_SESSION['USER_ID']=="WGE3"){ ?>
    ...
    <?php }
    else if($_SESSION['USER_ID']=="WBE4" || $_SESSION['USER_ID']=="WGE4"){ ?>
    ...
    <?php }
    else if($_SESSION['USER_ID']=="WGEA" || $_SESSION['USER_ID']=="WBEA"){ ?>
      <div class="inp">
        <div class="inp_name">Current Year </div>
        <div class="inp_value"><select id="cYear" onchange ="load_olms_query()">
          <option value="ENGG-ALL">All</option>
  ...
  <script type="text/javascript" src="../../assets/js/nicEdit-latest.js"></script> <script type="text/javascript">
    ...
    function olms_action(ac,actions)
    {
      ...
      alert(msg);
      if(msg==" Sucessfull"){
        window.location.href="olms_approved";
      }
    }
    $(function(){
