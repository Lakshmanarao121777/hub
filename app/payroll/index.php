...
<body>
  ...
  <div class="container bg_white" style="padding:0;">
    <ul class="bread">
      ...
      <li class="breadcurrent"><a href="./" title=""><em><span class="fa fa-tachometer-alt"></span> Payroll Dashboard</em></a></li>
    </ul>
    <?php if($_SESSION['USER_DESIGNATION']=="admin" || $_SESSION['USER_DESIGNATION']=="adminebs"){
      ?>
      <div class="dash_box">
        <a href="users">
