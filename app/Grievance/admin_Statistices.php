...
fieldset{width:48%;float:left;margin:10px 1% 1% 1%;}
...
.inp{width:100%;float: left;}
  ...
  .sarath{width:19%;border:1px solid gray;border-radius:5px;float:left;margin:10px 1% 5px 0;font-size:14px;}
...
@media only screen and (max-width: 768px) {
  ...
  .sarath{width:48%;border:1px solid gray;border-radius:5px;float:left;margin:10px 1% 2% 0;padding:10px;}
...
<body>
  ...
  <div class="container bg_white" style="padding:0 0 100px 0;">
    <ul class="bread">
      ...
      <li class="breadcurrent"><a href="#" title=""><em><span class="fa fa-chart-bar"> </span> Statistices</em></a></li>
    </ul>
    <?php
    ...
    $dept = $designation->getColValue("gre_users", "userId='$_SESSION[USER_ID]'","department");
      $posted = $designation->getCount("gre_complaints", "department='$dept' and status='Posted' ");
      $postedall = $designation->getCount("gre_complaints", "department='$dept'");
      $solved = $designation->getCount("gre_complaints", "department='$dept' and status='Solved' ");
      $rejected = $designation->getCount("gre_complaints", "department='$dept' and status='Rejected' ");
      $pending = $designation->getCount("gre_complaints", "department='$dept' ");
      $pending=$pending-$posted-$solved-$rejected;
    ?>
    <div class="sarath pp">
      <b style="color:rgba(255,255,255,0.8);">Compalint(s) Posted </b><br> <span class="numbershow"><i class="fa fa-sync-alt ico"></i> <?php echo $postedall; ?> </span> 
    </div>
    <div class="sarath pp">
      <b style="color:rgba(255,255,255,0.8);">Compalint(s) Un Viewed </b><br> <span class="numbershow"><i class="fa fa-sync-alt ico"></i> <?php echo $posted; ?> </span> 
    </div>
    <div class="sarath ss">
    ...
    <fieldset>
      <div class="inp">
        ...
        <option value="Posted">Un Viewd</option>
        <option value="Viewed">Viewd</option>
    ...
    <div class="clear"></div>
    <center><button class="btn btn-primary" onclick="showComplaints('<?php echo $userId; ?>')"> Show Results </button></center>
    <div id="show"></div>
