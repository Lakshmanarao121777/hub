...
<body>
  ...
  <ul class="bread">
    ...
    if ($user_designation == "CoOrdinator" ) { ?>
      ...
      <div class="dash_box">
        <a href="admin_users_modify">
          <span class="fa fa-user-edit icon" ></span> <div class="link_text"> User Modifications <span class="fa fa-arrow-alt-circle-right sm-icon"> </span></div>
        </a>
      </div>
    <?php } ?>
