...
<body>
  ...
  <div class="container bg_white" style="padding:0;">
    <ul class="bread">
      ...
      <li><a href="stu_summer" title=""><em><span class="fa fa-book"> </span> Summer Semister</em></a></li>
      <li class="breadcurrent"><a href="#" title=""><em><span class="fa fa-graduation-cap"></span> AY18-19 Summer Sem-1</em></a></li>
    </ul>
    <?php
