  ...
  <div class="container bg_white">
    ...
    <?php
    	if(isset($_POST["push_notice"]))
    	{
    		...
    		$fileName4 = $_FILES["att4"]["tmp_name"];$fileN4=$_FILES["att4"]["name"];
    		$fileName5 = $_FILES["att5"]["tmp_name"];$fileN5=$_FILES["att5"]["name"];
    		$fileName6 = $_FILES["att6"]["tmp_name"];$fileN6=$_FILES["att6"]["name"];
    		$fileName7 = $_FILES["att7"]["tmp_name"];$fileN7=$_FILES["att7"]["name"];
    		$fileName8 = $_FILES["att8"]["tmp_name"];$fileN8=$_FILES["att8"]["name"];
