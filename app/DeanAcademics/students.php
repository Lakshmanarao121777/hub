...
<body>
  ...
  <div class="container bg_white">
    <div class="search bg_white ball">
      <form method="post" name="serachid" >
        ...
        <div class="enterid"><input type="text" name="searchingid" required="required" placeholder="Student Id Number" onchange="SerachStudent();return false;" onkeyup="SerachStudent();return false;"></div>
      </form>
    </div>
  ...
  function SerachStudent()
  {
    ...
    var values =['stu_chip_Show',idnumber];
    if(idnumber.length>=6){var msg=SendToPhp(values,"../../php/controllers/DeanAcademics.php");
